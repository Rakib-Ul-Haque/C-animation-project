...
float DensityM, DensityM1, DensityN, DensityP ;
float fMx, fM1x, fNx, fPx ;
float fMy, fM1y, fNy, fPy ;
...
void diffuse_matter(int n, fftw_real *vx, fftw_real *vy, fftw_real *rho, fftw_real *rho0, fftw_real dt) 
{
	...
	for ( x=0.5f/n,i=0 ; i<n ; i++,x+=1.0f/n )
		for ( y=0.5f/n,j=0 ; j<n ; j++,y+=1.0f/n ) 
		{
			...
			DensityM=((DensityN+DensityP)/2);
			DensityM1=((DensityM+DensityN)/2);
...
void rainbow(float yval, float* r,float* g,float* b)
{ 
	if (yval < 0.20)
		{*r=yval/0.2;*g=yval/0.2;*b=0.0;return;}
	if ((yval>=0.20) && (yval < 0.50))
		{*r=0.0;*g=(yval-0.2)/0.50;*b=0.0;return;}
	if ((yval>=0.50) && (yval < 0.89))
		{*r=0.0;*g=(yval-0.5)/0.89;*b=(yval-0.5)/0.89;return;}
	if (yval>=0.89)
		{*r=0.0;*g=0.0;*b=(yval-0.89)/0.11;return;}
}
...
void display(void) 
{
	...
	drawString(GLUT_BITMAP_9_BY_15, 705, 470, str);
	glEnd();
	glFlush();
	
	glColor3f(1.0, 1.0, 1.0);
	drawString(GLUT_BITMAP_9_BY_15, 870, 470, strr);
	glEnd();
	glFlush();

	
	glColor3f(1.0, 1.0, 1.0);
	gcvt(DensityP, 4, Str1);
	drawString(GLUT_BITMAP_9_BY_15, 705, 420, Str1);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(DensityM, 4, Str2);
	drawString(GLUT_BITMAP_9_BY_15, 705, 330, Str2);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(DensityM1, 4, Str3);
	drawString(GLUT_BITMAP_9_BY_15, 705, 200, Str3);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(DensityN, 4, Str4);
	drawString(GLUT_BITMAP_9_BY_15, 705, 100, Str4);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(fPx, 4, Strr1);
	drawString(GLUT_BITMAP_9_BY_15, 870, 420, Strr1);
	glEnd();
	glFlush();
	
	glColor3f(1.0, 1.0, 1.0);
	gcvt(fPy, 4, Strrr1);
	drawString(GLUT_BITMAP_9_BY_15, 870, 400, Strrr1);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(fMx, 4, Strr2);
	drawString(GLUT_BITMAP_9_BY_15, 870, 330, Strr2);
	glEnd();
	glFlush();
	
	glColor3f(1.0, 1.0, 1.0);
	gcvt(fMy, 4, Strrr2);
	drawString(GLUT_BITMAP_9_BY_15, 870, 310, Strrr2);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(fM1x, 4, Strr3);
	drawString(GLUT_BITMAP_9_BY_15, 870, 200, Strr3);
	glEnd();
	glFlush();
	
	glColor3f(1.0, 1.0, 1.0);
	gcvt(fM1y, 4, Strrr3);
	drawString(GLUT_BITMAP_9_BY_15, 870, 180, Strrr3);
	glEnd();
	glFlush();

	glColor3f(1.0, 1.0, 1.0);
	gcvt(fNx, 4, Strr4);
	drawString(GLUT_BITMAP_9_BY_15, 870, 100, Strr4);
	glEnd();
	glFlush();
	
	glColor3f(1.0, 1.0, 1.0);
	gcvt(fNy, 4, Strrr4);
	drawString(GLUT_BITMAP_9_BY_15, 870, 80, Strrr4);
	glEnd();
